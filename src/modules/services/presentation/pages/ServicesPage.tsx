        ...
        <Table>
          <TableHeader className="bg-muted/50">
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead
                className="hover:text-primary cursor-pointer text-right font-semibold transition-colors"
        ...
        <div className="bg-muted/20 flex items-center justify-between border-t px-4 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              onClick={() => handlePageChange(filters.page! + 1)}
              disabled={
                (services && services.length < (filters.limit || 10)) ||
                isLoading
              }
              className="h-8 gap-1"
            >
