...
import type { ProductAttributeDataType } from "../../domain/entities/category_entity";
...
export function AddAttributeDialog({
  ...
  const [dataType, setDataType] = useState<ProductAttributeDataType>("string");
      ...
      <DialogContent className="sm:max-w-106.25">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Create a new attribute for this category. Attributes define the
              properties that products in this category can have.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select
                value={dataType}
                onValueChange={(value) =>
                  setDataType(value as ProductAttributeDataType)
                }
                disabled={isPending}
              >
